...
const CreateUserScreen = ({ navigation }) => {
  ...
  }, [formData, validateForm, createUser, navigation]);
  ...
  // ==================== RENDER ====================
  return (
    <AuthenticatedWrapper title="Crear Usuario" subtitle="Nuevo Usuario">
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSubtitle}>Agregar nuevo usuario al sistema</Text>
        </View>
      </View>
